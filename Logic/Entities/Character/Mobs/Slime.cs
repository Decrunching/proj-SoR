...
namespace Logic.Entities.Character.Mobs
{
    ...
    internal class Slime : Entity
    {
        public Slime(GraphicsDeviceManager graphics, GraphicsDevice GraphicsDevice)
        {
            ...
            atlas = new Atlas(GetPath("Content\\SoR Resources\\Entities\\Slime\\Slime.atlas"), new XnaTextureLoader(GraphicsDevice));
            ...
            skeletonData = json.ReadSkeletonData(GetPath("Content\\SoR Resources\\Entities\\Slime\\skeleton.json"));
