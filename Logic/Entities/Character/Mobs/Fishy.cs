...
namespace Logic.Entities.Character.Mobs
{
    ...
    internal class Fishy : Entity
    {
        public Fishy(GraphicsDeviceManager graphics, GraphicsDevice GraphicsDevice)
        {
            ...
            atlas = new Atlas(GetPath("Content\\SoR Resources\\Entities\\Fishy\\Fishy.atlas"), new XnaTextureLoader(GraphicsDevice));
            ...
            skeletonData = json.ReadSkeletonData(GetPath("Content\\SoR Resources\\Entities\\Fishy\\skeleton.json"));
